 ...
 1. Используя навыки приобретенные в предыдущем уроке, составьте скрипт выполняющий:
    ...
    1.3 добавление пользователя в sailor (или любого другого) с правом запуска контейнеров
 2. Используя пользователя из пункта 1.3 запустить контейнер ubuntu:16.10 в интерактивном режиме
